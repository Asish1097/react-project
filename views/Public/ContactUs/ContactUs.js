        ...
        <main className={S.main}>
          ...
          <div className={S.banner_sec}>
            <div className='container'>
              <div className="row">
                <h2 className={`text-center  ${S.contact_heading}`}>Contact Us</h2>
              </div>
              <div className="row">
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3">
                  <div className={`${S.contact_snapchat} ${S.contact_details}`}>
                    <img
                      ...
                      src={SnapchatIcon}
                      alt="Snapchat" />
                    <h2 className={S.contact_snapchat_heading}> <a href="">Snapchat.com/postablur</a> </h2>
                ...
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3">
                  <div className={`${S.contact_twitter} ${S.contact_details}`}>
                    <img
                      ...
                      src={TwitterIcon}
                      alt="Twitter" />
                    <h2 className={S.contact_twitter_heading}> <a href="">Twitter.com/postablur</a> </h2>
                    <p>Send us a message with a question or comment.</p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3">
                  <div className={`${S.contact_youtube} ${S.contact_details}`}>
                    <img
                      ...
                      src={YoutubeIcon}
                      alt="Youtube" />
                    <h2 className={S.contact_youtube_heading}> <a href="">Youtube.com/postablur</a> </h2>
                    <p>Send us a message with a question or comment.</p>
                  </div>
                </div>
                ...
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3 mt-lg-3">
                  <div className={`${S.contact_facebook} ${S.contact_details}`}>
                    <img
                      ...
                      src={FacebookIcon}
                      alt="Facebook" />
                    <h2 className={S.contact_facebook_heading}> <a href="">Facebook.com/postablur</a> </h2>
                    <p>Send us a message with a question or comment.</p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3 mt-lg-3">
                  <div className={`${S.contact_instagram} ${S.contact_details}`}>
                    <img
                      ...
                      src={InstaIcon}
                      alt="Instagram" />
                    <h2 className={S.contact_instagram_heading}> <a href="">Instagram.com/postablur</a> </h2>
                    <p>Send us a message with a question or comment.</p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-4 col-12 mt-3 mt-md-3 mt-lg-3">
